...
import com.web.bloomex.kyc.SelectCountryScreen;
...
public class SelectCountryAdapter extends RecyclerView.Adapter<SelectCountryAdapter.MyViewHolder> {
    ...
    public SelectCountryAdapter(SelectCountryScreen showFiatCurrencyDepositWithdraw, ArrayList<JSONObject> dataAr) {
        this.moviesList = dataAr;
        this.ira1 = showFiatCurrencyDepositWithdraw;

    }
    public SelectCountryAdapter(SelectCountryScreen showFiatCurrencyDepositWithdraw) {
        this.ira1 = showFiatCurrencyDepositWithdraw;
